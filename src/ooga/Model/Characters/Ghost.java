...
public class Ghost extends AbstractCharacter {
  ...
  public void setImageFiles() throws FileNotFoundException {
    IDLE_IMAGE_RIGHT = new Image(
        new FileInputStream("data/spritesheets/ghost/ghost-idle-right.png"));
    ...
    ATTACK_IMAGE_RIGHT = new Image(
        new FileInputStream("data/spritesheets/ghost/ghost-attack-right.png"));
    ATTACK_IMAGE_LEFT = new Image(
        new FileInputStream("data/spritesheets/ghost/ghost-attack-left.png"));

    JUMP_IMAGE_RIGHT = new Image(
        new FileInputStream("data/spritesheets/ghost/ghost-jump-right.png"));
